...
const SellerList = () => {
    ...
    useEffect(() => {
        const fetchSellers = async () => {
            ...
            setLoading(true);
            try {
                const res = await axios.get("http://localhost/api/sellers/search", {
                    params: {
                        keyword: keyword,
                        page: 0,
                        size: 50,
    ...
    const getSellerImageUrl = (seller) => {
        const url = seller.profileImageUrl || seller.storeImageUrl;
            ...
            >
                <div className="seller-card">
                    ...
                    <div className="seller_text">
                        ...
                        <p className="seller_address">📍 {seller.addressDetail || '주소 정보 없음'}</p>

                        <p className="seller_status">
                            {isOpen ? '영업중' : '영업종료'}
                        </p>
                    </div>
                </div>
