        ...
        <div className="homepageUI">
            <div className="homepageTitle">
                ...
                <span className="homepageTitleUI allWatch">
                    <a href="/sail">
                        전체보기
                        <svg width="16" height="17" viewBox="0 0 16 17" fill="none" class="titleResponsive_arrow">
                            <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M5.667 13.5l5-5-5-5"></path>
                        </svg>
                    </a>
                </span>
            </div>
