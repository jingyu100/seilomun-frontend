...
function MainLastSP() {
  ...
  useEffect(() => {
    axios.get("http://localhost/api/products/search", {
      params: {
        keyword: "",
        filterType: "RECENT",
        ...
        <div className="product_text">
          ...
          <div className="product_info">
            ...
            <div className="product_price_container">
              <span className="product_regularprice">{product.regularPrice.toLocaleString()}원</span>
        ...
        <div className="homepageUI">
            <div className="homepageTitle">
                ...
                <span className="homepageTitleUI allWatch">
                    <a href="/sail">
                        전체보기
                        <svg width="16" height="17" viewBox="0 0 16 17" fill="none" className="titleResponsive_arrow">
                            <path stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" d="M5.667 13.5l5-5-5-5"></path>
                        </svg>
                    </a>
                </span>
            </div>
