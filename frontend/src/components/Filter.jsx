...
const Filter = () => {
    ...
    const categories =[ "과일", "채소", "과자/초코릿/시리얼", "쌀/잡곡", "수산물/건어물",
    ...
    return (<div className={"filter-container"}>
        <div className={"filter-section"}>
            <h3>위치</h3>
            <p>서울특별시</p>
            {locations.slice(0, showMoreLocation ? locations.length : 4).map((loc,index) => (
            ...
            <button onClick={() => setShowMoreLocation(!showMoreLocation)} className={"more-btn"}>
                {showMoreLocation ? "접기" : "더보기"}
            </button>
        </div>
