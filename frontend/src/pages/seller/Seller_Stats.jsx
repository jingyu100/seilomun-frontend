...
const Seller_Stats = () => {
  ...
  const loadStats = async () => {
    ...
    try {
      let url = `${API_BASE_URL}/api/orders/stats`;
          ...
          datasets: [
            {
              ...
              backgroundColor:
                chartType === "line" ? colors.sales + "20" : colors.sales + "CC",
              borderWidth: 3,
              fill: chartType === "line",
              tension: 0.4,
        ...
        <div className="stats-container">
          ...
          <div className="stats-controls">
            ...
            <div className="view-toggle">
              <button
                ...
                className={`toggle-btn ${
                  currentViewMode === "daily" ? "active daily" : ""
                }`}
              >
                📅 일별 보기
              </button>
              <button
                ...
                className={`toggle-btn ${
                  currentViewMode === "weekly" ? "active weekly" : ""
                }`}
              >
                📈 주간별 보기
              </button>
              <button
                ...
                className={`toggle-btn ${
                  currentViewMode === "monthly" ? "active monthly" : ""
                }`}
              >
                📊 월별 보기
              </button>
              <button
                ...
                className={`toggle-btn ${
                  currentViewMode === "quarterly" ? "active quarterly" : ""
                }`}
              >
                📋 분기별 보기
              </button>
              <button
                ...
                className={`toggle-btn ${
                  currentViewMode === "yearly" ? "active yearly" : ""
                }`}
              >
                🎯 연도별 보기
              </button>
            ...
            <div className="filter-controls">
              ...
              <button onClick={loadStats} disabled={loading} className="load-stats-btn">
                {loading ? "📊 로딩중..." : "📊 통계 조회"}
              </button>
            </div>
          </div>
