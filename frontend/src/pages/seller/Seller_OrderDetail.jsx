...
const Seller_OrderDetail = () => {
  ...
  const fetchOrderDetail = async () => {
    try {
      setLoading(true);
      const response = await api.get(`/api/sellers/orders/number/${orderNumber}`);
  ...
  const handleAcceptOrder = async () => {
    ...
    try {
      ...
      const response = await api.post(
        `/api/orders/acceptance/${orderDetail.orderId}`,
        {}
      );
  ...
  const handleRefuseOrder = async () => {
    ...
    try {
      setActionLoading(true);
      const response = await api.post(`/api/orders/refuse/${orderDetail.orderId}`, {});
