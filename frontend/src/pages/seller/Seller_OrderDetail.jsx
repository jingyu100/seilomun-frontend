...
const Seller_OrderDetail = () => {
    ...
    const fetchOrderDetail = async () => {
        try {
            setLoading(true);
            const response = await axios.get(`http://3.39.239.179/api/sellers/orders/number/${orderNumber}`, {
    ...
    const handleAcceptOrder = async () => {
        ...
        try {
            ...
            const response = await axios.post(
                `http://3.39.239.179/api/orders/acceptance/${orderDetail.orderId}`,
                {},
                { withCredentials: true }
            );
    ...
    const handleRefuseOrder = async () => {
        ...
        try {
            setActionLoading(true);
            const response = await axios.post(
                `http://3.39.239.179/api/orders/refuse/${orderDetail.orderId}`,
                {},
                { withCredentials: true }
            );
