...
const Change_dataPage = () => {
  ...
  const handlePasswordCheck = async () => {
    ...
    try {
      const res = await api.post("/api/customers/mypage/password", {
        ...
        <div className="mypage-container22">
          ...
          <div className="mypage-main">
            ...
            <p className="info-text">
              <strong className="email">{email}</strong> 님의 정보를 보호하기 위해
              <br />
              비밀번호를 다시 한번 확인합니다.
            </p>
            ...
            <div className="btn-group22">
              <button className="confirm-btn22" onClick={handlePasswordCheck}>
                확인
              </button>
              <button className="cancel-btn22" onClick={() => navigate("/mypage")}>
                취소
              </button>
            </div>
          </div>
