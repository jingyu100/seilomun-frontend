    ...
    <div>
      ...
      <div className="body sideMargin">
        <div className="register-Container">
          ...
          <label id="name-label">이름<span class="required">*</span></label>
            <div class="input-name">
                <input type="text" id="name-input" placeholder="이름을 입력해주세요" />
            </div>

            <label id="email-label">이메일<span className="required">*</span></label>
          ...
          <label id="phone-label">전화번호<span className="required">*</span></label>
          ...
          <label id="birth-label">생년월일<span className="required">*</span></label>
